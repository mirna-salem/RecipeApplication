...
namespace RecipeApplication.Areas.Identity.Pages.Account
{
    ...
    {
        private readonly SignInManager<RecipeApplicationUser> _signInManager;
        private readonly UserManager<RecipeApplicationUser> _userManager;
        private readonly IUserStore<RecipeApplicationUser> _userStore;
        ...
        private RecipeApplicationUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<RecipeApplicationUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(RecipeApplicationUser)}'. " +
                    $"Ensure that '{nameof(RecipeApplicationUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<RecipeApplicationUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<RecipeApplicationUser>)_userStore;
        }
